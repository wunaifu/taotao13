...
public class TestFastDFS {
	...
	public void uploadFile() throws Exception {
		...
		//3、加载配置文件
		ClientGlobal.init("D:/IdeaCode/taotao13/taotao-manager-web/src/main/resources/resource/client.conf");
		...
		String[] strings = storageClient.upload_file("D:/IdeaCode/a1.png", "png", null);
